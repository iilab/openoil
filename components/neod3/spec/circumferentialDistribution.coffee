describe 'circumferentialDistribution', ->
  ...
  it 'should spread out 2 arrows that are at exactly the same angle', () ->
  ...
  it 'should spread out 3 arrows that are at exactly the same angle', () ->
    arrowsThatAreTooCloseTogether =
      0: 0
      1: 0
      2: 0
