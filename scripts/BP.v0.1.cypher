...
MERGE (company:Company { name: line.company }) ON MATCH SET company.oc_id = line.oc_id, company.source_url = line.source_url, company.source_date = line.source_date, company.confidence = line.confidence, company.turnover = line.turnover, company.profit = line.profit, company.assets = line.assets, company.liabilities = line.liabilities
