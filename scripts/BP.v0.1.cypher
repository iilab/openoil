// Load BP
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/iilab/openoil/master/data/BP_ownership_20140711.csv' AS line
WITH line
MERGE (company:Company { name: line.company, oc_id: line.oc_id })
