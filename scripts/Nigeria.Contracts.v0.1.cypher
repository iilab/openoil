...
MERGE (contract:Contract { name: line.name, official_title: coalesce(line.offical_title, ""), description:line.description, value_usd:line.value_usd, value_currency_amount:line.value_currency_amount, value_currency_unit: line.value_currency_unit, announcement_date: coalesce(line.announcement_date,""), start_date:line.start_date, end_date: line.end_date, duration_months:line.duration_months, field:line.field, license_area:line.license_area})
